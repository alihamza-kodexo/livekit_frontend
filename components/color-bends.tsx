...
/**
 * Animated WebGL shader background (React Bits' "ColorBends").
 *
 * Vendored + typed for this project rather than pulled from a package --
 * it's a single self-contained file with no upstream updates to track.
 * Client-only: everything that touches `window`/WebGL runs inside
 * `useEffect`, so this renders an empty div during SSR and mounts the
